...
document.getElementById("check1").addEventListener("click", function(){
    ...
    console.log( "regEx1.exec(str1) : " + regEx2.exec(str1) );
    //console.log(regEx1.exec(str1));

    console.log( "regEx1.test(str2) : " + regEx2.test(str2) );
    console.log( "regEx1.exec(str2) : " + regEx2.exec(str2) );

    console.log( "regEx1.test(str3) : " + regEx2.test(str3) );
    console.log( "regEx1.exec(str3) : " + regEx2.exec(str3) );
